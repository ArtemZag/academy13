...
namespace BinaryStudio.PhotoGallery.Web.App_Start
{
	public class BootstrapBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/scripts/jquery").Include("~/Scripts/jquery-{version}.js"));
            BundleTable.Bundles.Add(new ScriptBundle("~/bundles/scripts/bootstrap").Include("~/Scripts/bootstrap.js"));
